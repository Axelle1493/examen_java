...
public class View {
    public static void main(String[] args) throws Exception {
        ...
        do {
            ...
            System.out.println("10-Affecter un professeur a une classe");
            System.out.println("11-Affecter un etudiant a une classe");
            ...
            switch (choix) {
                ...
                case 8:
                    ...
                    etudiants=  etudiantService.listerEtudiantsParClasse(libClasseRecherche);
                ...
                case 10:
                        ...
                        System.out.println("Entrez l'ID du professeur que vous souhaitez ajouter : ");
                        ...
                        // Affecter le professeur à la classe
                ...
                case 11:
                         ...
                         // Affecter l'étudiant à une classe
                        ...
                        System.out.println("Entrez l'ID de l'étudiant que vous souhaitez ajouter : ");
                        int idEtudiant1 = sc.nextInt();
                         ...
                         System.out.println("L'étudiant "+ etudiantClasse.getEtudiant().getNomComplet() +" a été ajouté avec succès dans la classe " + classeE.getLibelle());
